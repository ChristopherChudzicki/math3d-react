// flow-typed signature: 481827de05d7628f90b8c8c63bc67e00
// flow-typed version: 40f85e4e73/antd_v3.x.x/flow_>=v0.25.x
...
declare module "antd" {
  ...
  declare export type ButtonProps = {
    ...
    onClick?: (event: SyntheticEvent<HTMLButtonElement>) => void | () => void,
    block?: boolean
  }
  ...
  declare type TooltipSharedProps = {
    ...
    visible?: boolean,
    onVisibleChange?: (visible: boolean) => void | () => void,
    align?: AlignConfig
  }
