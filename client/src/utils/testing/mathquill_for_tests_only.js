/**
 * NOTE from Chris Chudzicki
 * As of Feb 7, 2019 MathQuill does not have an up-to-date npm version.
 * As such, we load it through a script tag in public folder and access it
 * through window.MathQuill.
 *
 * But some component tests require MathQuill, and Jest does not have access
 * to the copy loaded through script tag.
 *
 * This copy of MathQuill is ONLY for jest tests. Do NOT use in app. This file
 * contains lint that prevents create-react-app from compiling.
 */
